...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('json-compact-prettifier.prettyFormatCompact', function () {

        vscode.window.showInformationMessage("command format json registering");
